...
def writedata(FileName):
	...
	f.close()
#for FileName in ("chefmozparking","userpayment","chefmozaccepts","geoplaces2","userprofile","chefmozcuisine", "rating_final","chefmozhours4","usercuisine"):
writedata("usercuisine")
connector.commit()
cursor.close()
connector.close()
